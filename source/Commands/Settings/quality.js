...
async function createQualityImage(currentQuality, theme = "neon") {
  ...
  ctx.fillText("ARINO x DOLBY", 600, 100);
  ...
  ctx.fillStyle = colors.text;
  ctx.fillText("IMMERSE YOURSELF IN CRYSTAL-CLEAR SOUND WITH A͏R͏I͏N͏O͏", 600, 600);

  const buffer = canvas.toBuffer("image/png");
  return new AttachmentBuilder(buffer, {
    name: "arino_ryan_quality_settings.png",
  });
}
      ...
      const updateMessage = async (newQuality) => {
        try {
          ...
          const embed = new EmbedBuilder()
            .setTitle("🎧 A͏R͏I͏N͏O͏ HD Audio Experience")
            .setDescription(
            ...
            .setColor("#ff00ff")
            .setImage("attachment://arino_ryan_quality_settings.png");
