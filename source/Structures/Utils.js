...
module.exports = class BotUtils {
  ...
  async massDM(client) {
    try {
      const channel = client.channels.cache.get("1261779984448487444");
      ...
      const embedData = {
        ...
        title: "🎉 Arino has been Updated to V3!",
        description: `We're excited to announce that Arino has been updated to Version 1.0.3!\n\nThank you for being part of our journey!\nCurrently serving **${totalMembers.toLocaleString()}** users across all servers.`,
        fields: [
          {
            name: "🆕 What's New?",
            value:
          ...
          },
          {
            name: "🔗 Quick Links",
            value:
              "• [Click Here To Know More](https://discord.gg/W2GheK3F9m)\n• [Vote for Arino](https://top.gg/bot/1321595174056362111/vote)\n• [Invite Arino](https://discord.com/oauth2/authorize?client_id=1321595174056362111&permissions=8&scope=bot%20applications.commands)",
          },
        ],
        color: 0x2f3136,
        timestamp: new Date(),
        footer: {
          text: `You received this message because you\'re Arino Music's fav user`,
          iconURL: client.user.displayAvatarURL({ dynamic: true }),
        },
      };
